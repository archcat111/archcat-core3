 ...
 * @version 1.0
 * @description 某张表进行分表的规则
 *
 */
@Getter
@Setter
public class ShardingDataSourceShardingTablesTableProperties {
	
	private boolean enabled = false;
	
	//如：user_id, user_code
	private String tableShardingColumns; 
	private String tableShardingStrategyName = ShardingConstants.ShardingStrategyName.STANDARD;
	 ...
	 */
	private String tableShardingAlgorithmName; 
