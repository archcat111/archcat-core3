 ...
 * 
 * @author 王云龙
 * @date 2017年2月8日 下午7:48:53
 * @version 1.0
 * @description 处理cookie的工具
 *
 */
public class CookieUtil {
	 ...
	 * 
	 * @author wangyunlong
	 * @date 2017年8月13日 下午9:56:27
	 * @version 1.0
	 * @description 获取cookie的键值对，键为cookie的名称，值为cookie对象 
	 ...
	 * 
	 * @author 王云龙
	 * @date 2017年2月8日 下午7:49:08
	 * @version 1.0
	 * @description 读取指定cookie对象
	 * @param request HttpServletRequest
	 ...
	 * 
	 * @author wangyunlong
	 * @date 2017年8月13日 下午9:58:23
	 * @version 1.0
	 * @description 从cookie中获取对应name的value
	 * 如果cookie不存在，则返回null 
	 * @param request HttpServletRequest
	 * @param name cookie的名称，即cookie.getName()获取到的名称
	 * @return
	 ...
	 * 
	 * @author wangyunlong
	 * @date 2017年8月13日 下午10:04:56
	 * @version 1.0
	 * @description 添加新的cookie  
	 ...
	 * 
	 * @author wangyunlong
	 * @date 2017年8月13日 下午10:28:17
	 * @version 1.0
	 * @description 编辑指定的cookie 
	 * @param request HttpServletRequest
	 * @param response HttpServletResponse
	 * @param name name
	 * @param value value
